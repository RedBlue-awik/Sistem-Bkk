...
function tambahAdmin($data)
{
	...
	// Ambil semua kode_admin yang ada, urutkan ASC
	...
	$queryUser = "INSERT INTO user (kode_pengguna) VALUES('$kode_admin')";
...
function tambahSiswa($data)
{
	...
	// Insert data ke tabel user
	$queryUser = "INSERT INTO user (kode_pengguna) VALUES('$kode_alumni')";
...
function tambahPerusahaan($data)
{
	...
	$queryPerusahaan = "INSERT INTO perusahaan (nama_perusahaan, email, telepon, alamat, bidang_usaha, logo) VALUES('$nama', '$email', '$telepon', '$alamat', '$bidang_usaha', '$logo')";
...
function editPerusahaan($data)
{
	...
	$updatePerusahaan = "UPDATE perusahaan SET nama_perusahaan = '$nama', email = '$email', telepon = '$telepon', alamat = '$alamat', bidang_usaha = '$bidang_usaha', logo = '$logo' WHERE id_perusahaan = $id_perusahaan";
...
function tambahLoker($data)
{
	...
	$gajiLast = $mata_uang . ' ' . $gaji;

	// Query untuk menambahkan loker
	$queryLoker = "INSERT INTO lowongan (judul, deskripsi, persyaratan, gaji, tanggal_dibuka, tanggal_ditutup, id_perusahaan) 
				   VALUES('$judul', '$deskripsi', '$persyaratan', '$gajiLast', '$tanggal_dibuka', '$tanggal_ditutup', '$id_perusahaan')";

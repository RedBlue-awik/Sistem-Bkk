                            ...
                            <div class="col-12 col-md-8 d-flex align-items-start gap-3 flex-wrap info-header">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex flex-wrap align-items-baseline gap-3 mt-3 flex-column info">
                                        <span class="text-muted"><i class="bi bi-cash-stack" style="margin-right: .33rem;"></i><?= $data['gaji'] ?></span>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <?php else : ?>
                                            <a href="../../pages/view/logout.php" class="btn btn-sm px-5 btn-outline-primary">Hanya untuk Alumni</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="mt-1 ms-2 d-flex flex-column">
                                                        <span class="mb-1" style="font-size: 15px;"><strong><?= $loker['alamat']; ?></strong></span>
                                                        <?php
                                                        if ($isTutup) {
                                                ...
                                                <div class="d-flex flex-column align-items-center">
                                                    ...
                                                    <?php else : ?>
                                                        <a href="../../pages/view/logout.php" class="btn btn-sm btn-outline-primary">Khusus Alumni</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>

    ...
    function getHistoryLoker()
{
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        // Pisahkan mata uang dan nominal gaji
        preg_match('/^([^\d]+)\s*(.+)$/', $row['gaji'], $matches);
        $row['mata_uang'] = $matches[1] ?? ''; // Mata uang
        $row['nominal_gaji'] = $matches[2] ?? ''; // Nominal gaji

        // Pisahkan persyaratan menjadi array
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-3" id="lokerList">
                        <div class="row g-3 mt-3" id="lokerCards">
                            <?php if (empty($historyLoker)) : ?>
                                <div class="alert alert-info">Tidak ada loker yang sudah berakhir lebih dari 7 hari.</div>
                            <?php else : ?>
                                <!-- Daftar Loker -->
                                        ...
                                        <div data-id="<?= $loker['id_lowongan'] ?>" class="card-click card job-card h-100">
                                            <div class="card-body d-flex flex-column">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <span class="text-muted"><strong><?= $loker['gaji']; ?></strong></span>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="mt-1 ms-2 d-flex flex-column">
                                                            <span class="mb-1" style="font-size: 14px;"><strong><?= $loker['alamat']; ?></strong></span>
                ...
                <form action="" method="post" class="needs-validation" novalidate>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="input-group my-3">
                                <button class="btn btn-outline-secondary dropdown-toggle fs-5" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="currencyDropdown1">Rp</button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#" onclick="setCurrency('Rp', 1)">Rp - Rupiah</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="setCurrency('$', 1)">$ - Dollar</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="setCurrency('€', 1)">€ - Euro</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="setCurrency('£', 1)">£ - Pound</a></li>
                                </ul>
                    ...
                    <form action="" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="input-group my-3">
                                    <button class="btn btn-outline-secondary dropdown-toggle fs-5" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="currencyDropdown<?= $loker['id_lowongan']; ?>">
                                        <?= $loker['mata_uang']; ?>
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#" onclick="setCurrency('Rp', <?= $loker['id_lowongan']; ?>)">Rp - Rupiah</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="setCurrency('$', <?= $loker['id_lowongan']; ?>)">$ - Dollar</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="setCurrency('€', <?= $loker['id_lowongan']; ?>)">€ - Euro</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="setCurrency('£', <?= $loker['id_lowongan']; ?>)">£ - Pound</a></li>
                                    </ul>
                                    <input type="hidden" name="mata_uang" id="mata_uang<?= $loker['id_lowongan']; ?>" value="<?= $loker['mata_uang']; ?>">
                                    <div class="form-floating">
                                        <input id="gaji<?= $loker['id_lowongan']; ?>" type="text" name="gaji" class="gaji form-control" placeholder="Masukkan Gaji" value="<?= $loker['nominal_gaji']; ?>" autocomplete="off" />
    ...
    <script>
        function setCurrency(currency, id) {

            // Perbarui teks dropdown
            document.getElementById(`currencyDropdown${id}`).textContent = currency;

            // Perbarui nilai input hidden
            document.getElementById(`mata_uang${id}`).value = currency;
        }
    </script>

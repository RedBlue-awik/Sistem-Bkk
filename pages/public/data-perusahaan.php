                                                ...
                                                foreach ($perusahaan as $company) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap align-items-center">
                                                            <a href="" class="btn btn-sm btn-success mb-1" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $company['id_perusahaan']; ?>" data-bs-trigger="hover" data-bs-placement="top" data-bs-custom-class="custom-tooltip-Edit" data-bs-title="Edit ( Ubah )">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="input-group my-3">
                                    <div class="input-group-text"><span class="fas fa-envelope"></span></div>
                                    <div class="form-floating me-3">
                                        <input id="email" type="email" name="email" class="form-control" placeholder="" value="<?= $company["email"]; ?>" required autocomplete="off" />
                                        <label for="email" class="form-label">Email</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="telepon" id="telepon" maxlength="14" placeholder="" value="<?= $company["telepon"]; ?>" required autocomplete="off">
                                        <label for="telepon" class="form-label">No Telepon</label>
                                    </div>
                                    <div class="input-group-text"><span class="fas fa-phone"></span></div>
                                </div>
                                <div class="input-group my-3">
                                    ...
                                    <div class="input-group mt-3 mb-2">
                                        <div class="input-group-text"><span class="fas fa-map-location-dot"></span></div>
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="alamat" id="alamat" placeholder="" value="<?= $company["alamat"]; ?>" required autocomplete="off">
                                            <label for="alamat" class="form-label">Alamat</label>
                                        </div>
                                        <div class="input-group-text"><span class="fas fa-location-dot fa-bounce fa-lg"></span></div>
                                    </div>
